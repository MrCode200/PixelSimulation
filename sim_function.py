...
def generate_bat(num_generations):
...
def info_board(WIN):
    ...
    WIN.blit(INFO_ENERGY_SLIMY, (0, 60))
    WIN.blit(INFO_ENERGY_FOOD, (0, 75))
    WIN.blit(INFO_BINARY_FISSION, (0, 90))

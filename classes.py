...
class slimy(pygame.sprite.Sprite):
    ...
    def collide(self):
        ...
        food_reach_collide = pygame.sprite.spritecollide(self, v.FOOD_GROUP, True, pygame.sprite.collide_circle_ratio(0.2))
    ...
    def binary_fission(self):
        if self.energy >= v.SLIMY_ENERGY_CAP:
            ...
            self.energy -= 0.2 * (self.speed + self.radius / 15)
...
class food(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.energy < 500:
            self.energy += 0.1
            self.image = pygame.transform.scale(pygame.image.load(self.IMAGE_VERSION), (self.energy/4,self.energy/4))